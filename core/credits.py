...
class Credits:
    ...
    def __init_text(self):
        ...
        self.credits = [
            ...
            ("   Léo Ducruet (Animations & développement)", self.resources.subtitle_font),
            ("   Joan Le Fol (Développement des interactions)", self.resources.subtitle_font),
            ("   Valentin Wouters (UI/UX designer, développement & qualité)", self.resources.subtitle_font),
            ("", self.resources.description_font),
